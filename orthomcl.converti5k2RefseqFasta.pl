...
=head1 NAME
 ...
 orthomcl.convert2RefseqFasta.pl - Convert protein fasta and GFF files to Refseq like format for OrthomclAdjustFasta
...
=head1 DESCRIPTION
 ...
 Reads in Fasta file produced by i5k or ACT or Artemis. Formats the sequence headers to look like Refseq headers.
